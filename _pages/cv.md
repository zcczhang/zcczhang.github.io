...
- **Programming:** R(ggplot, ggmap, plotly, leaflet, gganimate, rvest, shinny), Python(numpy, pandas, easygui, matplotlib, gym, openCV, tensorflow), Java, SQL, MATLAB, HTML, CSS, Markdown, TeX, COMSOL
